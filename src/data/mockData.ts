...
export const mockContent: Content[] = [
  ...
  // TV Series (Top 10, reordered as requested)
  {
    ...
    rating: 9.5,
    review:
      "Masterpiece of television. Bryan Cranston's performance is absolutely phenomenal and the writing is impeccable.",
    isFavorite: true,
  ...
  },
  {
    ...
    rating: 8.9,
    review:
      "Timeless sitcom about friendship and life in New York. The chemistry between the cast is unmatched.",
    isFavorite: true,
  ...
  },
  {
    ...
    rating: 8.2,
    review:
      "Spanish heist thriller with complex characters. The Professor's plans are ingeniously crafted.",
    isFavorite: true,
  ...
  },
  {
    ...
    rating: 9.1,
    review:
      "Modern adaptation of classic detective stories. Benedict Cumberbatch and Martin Freeman are perfect.",
    isFavorite: false,
    genre: ["Crime", "Drama", "Mystery"],
  },
  {
    ...
    rating: 8.7,
    review:
      "Outstanding post-apocalyptic drama. Pedro Pascal and Bella Ramsey deliver emotionally powerful performances.",
    isFavorite: false,
    genre: ["Drama", "Horror", "Thriller"],
  },
  {
...

  {
    ...
    rating: 7.7,
    review:
      "Disturbing psychological thriller about obsession. Penn Badgley makes stalking uncomfortably compelling.",
    isFavorite: false,
  ...
  },
  {
    ...
    rating: 8.0,
    review:
      "Korean survival thriller with biting social commentary. Visually striking and emotionally devastating.",
    isFavorite: false,
  ...
  },
  {
    ...
    rating: 8.1,
    review:
      "Action-packed adaptation of Lee Child's novels. Alan Ritchson perfectly embodies the physical presence of Reacher.",
    isFavorite: false,
    genre: ["Action", "Crime", "Drama"],
  },
  {
  ...
  },
  {
    ...
    rating: 7.2,
    review:
      "James Gunn's irreverent take on DC villains. Violent, funny, and surprisingly heartfelt.",
    isFavorite: false,
  ...
  },
  {
    ...
    rating: 7.8,
    review:
      "Post-apocalyptic fairy tale with heart. The hybrid children concept is both touching and disturbing.",
    isFavorite: false,
  ...
  },
  {
    ...
    rating: 8.3,
    review:
      "Honest and funny coming-of-age series. Tackles important topics with humor and sensitivity.",
    isFavorite: false,
    genre: ["Comedy", "Drama"],
  },
  {
  ...
  },
  {
    ...
    rating: 7.3,
    review:
      "Period romance with modern sensibilities. Lavish production values and steamy romance.",
    isFavorite: false,
    genre: ["Drama", "Romance"],
  },
  {
    ...
    rating: 8.7,
    review:
      "Outstanding Indian spy thriller. Manoj Bajpayee delivers a powerhouse performance balancing family and duty.",
    isFavorite: false,
    genre: ["Action", "Drama", "Thriller"],
  },
  {
    ...
    rating: 8.4,
    review:
      "Gritty crime saga from the heartland of India. Raw and violent with compelling character arcs.",
    isFavorite: false,
    genre: ["Action", "Crime", "Drama"],
  },
  {
    ...
    rating: 8.5,
    review:
      "Harrowing true crime series with exceptional performances. Shefali Shah leads a compelling investigation.",
    isFavorite: false,
    genre: ["Crime", "Drama", "Thriller"],
  },
  {
    ...
    rating: 8.4,
    review:
      "Psychological thriller mixing mythology with modern crime. Intelligent writing and great performances.",
    isFavorite: false,
    genre: ["Crime", "Drama", "Thriller"],
  },
  {
    ...
    rating: 8.1,
    review:
      "Slick counterfeiting thriller with Shahid Kapoor. Well-crafted cat-and-mouse game.",
    isFavorite: false,
    genre: ["Crime", "Drama", "Thriller"],
  },
  {
    ...
    rating: 8.0,
    review:
      "Espionage thriller with stellar performances. Anil Kapoor and Aditya Roy Kapur excel in this adaptation.",
    isFavorite: false,
    genre: ["Drama", "Thriller", "Crime"],
  },
  {
    ...
    rating: 7.9,
    review:
      "Dark exploration of religious exploitation. Bobby Deol delivers a menacing performance as a corrupt guru.",
    isFavorite: false,
    genre: ["Crime", "Drama", "Thriller"],
  },
];
