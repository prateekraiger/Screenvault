  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="relative z-10 w-full px-2 sm:px-4 lg:px-8 xl:px-16 2xl:px-32 mx-auto min-h-screen">
        ...
        >
          <motion.h1
            className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-2xl"
            animate={{
          ...
          {/* Gaming Controller Icon Animation */}
          <motion.div
          ...
          >
            <p className="text-cyan-100/90 text-xl md:text-2xl leading-relaxed font-medium">
              Welcome to my digital playground! Dive into my favorite gaming
              experiences, from competitive FPS battles to epic story-driven
              adventures.
            </p>
            <p className="text-cyan-200/80 text-lg md:text-xl leading-relaxed">
              Each game tells a story, every match is a new challenge, and every
              victory feels earned. Explore the games that have shaped my gaming
              journey.
            </p>
          </motion.div>
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Special badge for Peak Rating */}
                    {stat.label === "Peak Rating" && (
                      <motion.div
                        className="absolute -top-2 -right-2 bg-gradient-to-r from-green-400 to-emerald-400 text-black text-xs font-bold px-2 py-1 rounded-full"
                        animate={{
                          scale: [1, 1.1, 1],
                          rotate: [0, 5, -5, 0],
                        }}
